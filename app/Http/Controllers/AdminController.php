...
class AdminController extends Controller
{
    ...
    // {
    //     $internships = Internship::with('applicants')->get();
    //     $users = User::where('role', 'user')->get(); // Role 'user' sebagai peserta
    //     $mentors = User::where('role', 'mentor')->get(); // Role 'mentor' sebagai pembimbing

    //     $jumlahPendaftar = $users->count();
    //     $jumlahPeserta = $internship_registrations->count();

    //     return view('admin.dashboard', compact('internships', 'users', 'mentors', 'jumlahUser', 'jumlahMentor'));
    // }
