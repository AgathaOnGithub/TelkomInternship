        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <div class="text-center" data-aos="fade-up">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="{{ asset('images/profile/default.png') }}" alt="Putra Satria Nagara M." class="object-cover w-full h-full">
                </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="{{ asset('images/profile/default.png') }}" alt="Viona Mojang Pamungkas" class="object-cover w-full h-full">
                </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="{{ asset('images/profile/default.png') }}" alt="Jasmine Nayla Hafiezh" class="object-cover w-full h-full">
                </div>
