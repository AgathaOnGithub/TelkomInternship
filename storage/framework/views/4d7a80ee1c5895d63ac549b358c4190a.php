   ...
   <!-- Kartu Informasi Pendaftar & Peserta (Horizontal) -->
    <div class="flex flex-wrap gap-4 mt-6 justify-between items-center">
        ...
        <div class="flex-1 min-w-[200px] bg-white shadow-md p-4 rounded-lg text-center">
            ...
            <h3 class="text-blue-600 font-bold text-xl"><?php echo e($jumlahPendaftar); ?> Users</h3>
        ...
        <div class="flex-1 min-w-[200px] bg-white shadow-md p-4 rounded-lg text-center">
            ...
            <h3 class="text-green-600 font-bold text-xl"><?php echo e($jumlahPembimbing); ?> Pembimbing </h3>
            <i class="bi bi-person-badge text-green-600 text-2xl"></i>
        </div>

        <!-- Tombol Tambah Program -->
        <div class="flex-1 min-w-[200px]">
            <a href="<?php echo e(route('admin.internships.create')); ?>" class="block bg-[#679CEB] text-white text-center font-bold py-4 px-4 rounded-lg w-full h-full">
            ...
            <table class="w-full border border-gray-300 rounded-lg">
                ...
                <tbody>
                    ...
                    <tr class="text-center bg-gray-100">
                        <td class="px-4 py-2 border"><?php echo e($internship->name); ?></td>
                        <td class="px-4 py-2 border"><?php echo e($internship->description); ?></td>
                        <td class="px-4 py-2 border"><?php echo e($internship->location); ?></td>
                        <td class="px-4 py-2 border flex justify-center gap-2">
                            <!-- Tombol Lihat -->
                            <a href="<?php echo e(route('internships.show', $internship->id)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded flex items-center">
                                <i class="bi bi-eye mr-1"></i> Lihat
                            </a>

                            <!-- Tombol Edit -->
                            <a href="<?php echo e(route('admin.internships.edit', $internship->id)); ?>" class="bg-yellow-500 text-white px-2 py-1 rounded flex items-center">
                                <i class="bi bi-pencil mr-1"></i> Edit
                            </a>

                            <!-- Tombol Hapus -->
                            <form action="<?php echo e(route('admin.internships.destroy', $internship->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus ini?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\magangtelkom\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>