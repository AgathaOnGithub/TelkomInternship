...
<div class="relative">
    <div class="slideshow-container h-[300px] relative overflow-hidden">
        <!-- Slide 1 -->
        <div class="slides bg-cover bg-center" style="background-image: url('<?php echo e(asset('banner1.png')); ?>');">
    ...
    <div class="bg-[#F3F4F6] shadow-md p-8 rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="<?php echo e(asset('images/profile/default.png')); ?>" alt="Jasmine Nayla" class="object-cover w-full h-full">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\hawa\digistar\TelkomInternship\resources\views/home.blade.php ENDPATH**/ ?>