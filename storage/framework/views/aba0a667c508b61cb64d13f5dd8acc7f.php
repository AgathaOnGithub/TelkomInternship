...
<div class="relative">
    <div class="slideshow-container h-[300px] relative overflow-hidden">
        <!-- Slide 1 -->
        <div class="slides bg-cover bg-center active" style="background-image: url('<?php echo e(asset('banner1.png')); ?>');">
        ...
        <!-- Slide 2 -->
        <div class="slides bg-cover bg-center" style="background-image: url('<?php echo e(asset('banner2.png')); ?>');">
        ...
        <!-- Slide 3 -->
        <div class="slides bg-cover bg-center" style="background-image: url('<?php echo e(asset('banner3.png')); ?>');">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            ...
            <div class="text-center" data-aos="fade-up">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="<?php echo e(asset('images/profile/default.png')); ?>" alt="Putra Satria Nagara M." class="object-cover w-full h-full">
                </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="<?php echo e(asset('images/profile/default.png')); ?>" alt="Viona Mojang Pamungkas" class="object-cover w-full h-full">
                </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                <div class="relative overflow-hidden rounded-lg w-40 h-48 mx-auto bg-gray-100">
                    <img src="<?php echo e(asset('images/profile/default.png')); ?>" alt="Jasmine Nayla Hafiezh" class="object-cover w-full h-full">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\hawa\digistar\TelkomInternship\resources\views/dashboard/index.blade.php ENDPATH**/ ?>