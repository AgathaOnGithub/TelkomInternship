        ...
        <ul id="menu" class="hidden flex-col gap-4 absolute top-16 left-0 w-full bg-[#679CEB] lg:static lg:flex lg:flex-row lg:items-center lg:w-auto">
            <li>
                ...
                <a href="{{ route('admin.messages.inbox') }}"
                    class="block {{ request()->routeIs('admin.messages.inbox') ? 'text-gray-700 font-semibold' : 'text-white' }} hover:text-gray-200 px-4 py-2">
                    Inbox
                </a>
                @else
                <a href="{{ route('contact') }}"
                    class="block {{ request()->routeIs('contact') ? 'text-gray-700 font-semibold' : 'text-white' }} hover:text-gray-200 px-4 py-2">
                    Hubungi Kami
                </a>
                @endif
            </li>
